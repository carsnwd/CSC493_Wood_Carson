...
{
    //Left mountain texture
    private TextureRegion regMountainLeft;

    //Right mountain texture
    private TextureRegion regMountainRight;

    //How long to make the middle mountain texture
    private int length;
    ...
    /**
     * Draws mts, includes scrolling
     * @param batch
     * @param offsetX
     * @param offsetY
     * @param tintColor
     * @param parallaxSpeedX - scrolling speed
     */
    ...
    /**
     * Changes the position of the mts while scrolling
     * @param camPosition
     */
